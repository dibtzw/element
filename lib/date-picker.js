...
module.exports = require("dib-element-ui/lib/utils/date-util");
...
module.exports = require("dib-element-ui/lib/button");
...
// EXTERNAL MODULE: external "dib-element-ui/lib/utils/date-util"
...
// EXTERNAL MODULE: external "dib-element-ui/lib/button"
                ...
                _c("div", [
                  _c("a", { staticClass: "cell" }, [
                    _vm._v(
                      _vm._s(
                        _vm.t(
                          "el.datepicker.months_num." + _vm.months[cell.text]
                        )
                      )
                    ),
                  ]),
...
/* harmony default export */ var datevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    prevYear: function prevYear() {
      if (this.currentView === 'year') {
        this.date = Object(date_util_["prevYear"])(this.date, 12);
      } else {
    ...
    nextYear: function nextYear() {
      if (this.currentView === 'year') {
        this.date = Object(date_util_["nextYear"])(this.date, 12);
      } else {
  ...
  computed: {
    ...
    yearLabel: function yearLabel() {
      ...
      if (this.currentView === 'year') {
        var startYear = Math.floor(this.year / 12) * 12;
        if (yearTranslation) {
